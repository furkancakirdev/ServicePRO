  ...
  return (
    <PageContent>
      <PageHeader
        ...
        description="Is emri detayi"
        breadcrumbs={[
          { label: 'Operasyon', href: '/' },
          { label: 'Is Emirleri', href: '/servisler' },
          { label: `Is #${service.id.slice(-6).toUpperCase()}` },
        ]}
        rightActions={
          <div className="flex flex-wrap items-center gap-2">
            <Link href={`/servisler/${service.id}/duzenle`} className="btn btn-primary h-10 px-4 py-2">
              Duzenle
            </Link>
      ...
      >
        <div className="flex flex-wrap items-center gap-2">
          <span className="chip">Is #{service.id.slice(-6).toUpperCase()}</span>
